...
4. 金融资源：用于雇佣关键人员和重点合作方的可分配的公司股票期权池、流动现金、信贷额度
...
- 平台处理客户关系中的一些服务也影响着平台的收入来源。就比如客户关系中的自助服务，用户可以根据自己的需要来决定是否充值会员享受更优质的服务，处理好相关的关系可以帮助平台获得更多来自会员充值等形式的收入来源。

#### 5.核心资源

##### 成本结构

- 维持官方网站、APP软件的正常运营，购买专有数据库需要支付对应人力、设备费用；购买实体剧本、剧本专利，需要付专利费用、版权费用；经营销售团队、软件团队、法务团队、公司战略发展决策团队、公众号，自营剧本杀门店、剧本杀工作室需要付人力资源费用、场地费用。
...
- 与工作室、实体店的合作需要付一定的基础费用，以支持线上平台提供工作室、实体店的互动、使用场地等相关服务，需要付对应费用；与流量平台合作举办活动、邀请测评师测评，需要付活动、测评费用；购买云服务商的服务器、存储空间需要付一笔云服务费用。
